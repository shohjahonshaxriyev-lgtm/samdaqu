...
import { Search, HelpCircle, UploadCloud, Sun, Moon, User } from 'lucide-react';
...
function AppContent() {
  ...
  const navItems = [
    ...
    { id: 'profile', label: 'Profil', icon: User, color: 'text-pink-500' },
    { id: 'help', label: 'Yordam', icon: HelpCircle, color: 'text-orange-500' },
    { id: 'upload', label: 'Boshqaruv', icon: UploadCloud, color: 'text-emerald-500' },
  ];

  return (
    <div className="h-[100dvh] w-full overflow-hidden flex flex-col md:flex-row bg-slate-50 dark:bg-slate-900 transition-colors duration-300 text-slate-800 dark:text-slate-100 relative">
      <AnimatePresence>
