...
export default function BottomNav({ activeTab, setActiveTab }) {
  const navItems = [
    ...
    { id: 'upload', label: 'Boshqaruv', icon: Settings },
  ];

  return (
    <nav 
      className="fixed bottom-0 left-0 right-0 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg border-t border-slate-200/40 dark:border-slate-800/40 px-2 md:hidden bottom-nav-hide"
      style={{
